...
| <a name="input_cloud_monitoring_provision"></a> [cloud\_monitoring\_provision](#input\_cloud\_monitoring\_provision) | Provision a IBM cloud monitoring instance? | `bool` | `false` | no |
...
| <a name="input_logs_policy_name"></a> [logs\_policy\_name](#input\_logs\_policy\_name) | The name of the IBM Cloud Logs policy to create. Defaults to 'cloud-logs-<region>-policy' | `string` | `"logs-policy"` | no |
...
| <a name="output_logs_policy_id"></a> [logs\_policy\_id](#output\_logs\_policy\_id) | The id of the Cloud logs policy created. |
| <a name="output_logs_policy_order"></a> [logs\_policy\_order](#output\_logs\_policy\_order) | The order of the policy created in relation to the other policies. |
| <a name="output_logs_policy_status"></a> [logs\_policy\_status](#output\_logs\_policy\_status) | The status of the Cloud logs policy created. |
