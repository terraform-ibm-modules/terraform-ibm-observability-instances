...
| <a name="input_log_analysis_access_tags"></a> [log\_analysis\_access\_tags](#input\_log\_analysis\_access\_tags) | A list of access tags to apply to the LogDNA instance created by the module. For more information, see https://cloud.ibm.com/docs/account?topic=account-access-tags-tutorial. | `list(string)` | `[]` | no |
