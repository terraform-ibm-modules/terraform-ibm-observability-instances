...
| <a name="output_cos_target_id"></a> [cos\_target\_id](#output\_cos\_target\_id) | The id of the provisioned COS target route. |
...
| <a name="output_eventstreams_target_id"></a> [eventstreams\_target\_id](#output\_eventstreams\_target\_id) | The id of the provisioned event streams target route. |
...
| <a name="output_logdna_target_id"></a> [logdna\_target\_id](#output\_logdna\_target\_id) | The id of the provisioned LogDNA target route. |
