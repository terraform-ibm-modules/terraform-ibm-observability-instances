...
| <a name="input_logdna_resource_key_role"></a> [logdna\_resource\_key\_role](#input\_logdna\_resource\_key\_role) | The role to give the IBM Cloud Logging key. | `string` | `"Manager"` | no |
