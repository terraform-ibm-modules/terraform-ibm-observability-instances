...
| <a name="input_cos_targets"></a> [cos\_targets](#input\_cos\_targets) | Map of cos targets to be created | <pre>map(object({<br>    endpoint                   = string<br>    bucket_name                = string<br>    instance_id                = string<br>    api_key                    = optional(string)<br>    service_to_service_enabled = optional(bool, false)<br>    target_region              = optional(string)<br>  }))</pre> | `{}` | no |
...
| <a name="input_eventstreams_targets"></a> [eventstreams\_targets](#input\_eventstreams\_targets) | Map of event streams targets to be created | <pre>map(object({<br>    instance_id   = string<br>    brokers       = list(string)<br>    topic         = string<br>    api_key       = string<br>    target_region = optional(string)<br>  }))</pre> | `{}` | no |
...
| <a name="input_logdna_targets"></a> [logdna\_targets](#input\_logdna\_targets) | Map of routes to be created, maximum four routes are allowed | <pre>map(object({<br>    instance_id   = string<br>    ingestion_key = string<br>    target_region = optional(string)<br>  }))</pre> | `{}` | no |
