...
| <a name="input_logdna_targets"></a> [logdna\_targets](#input\_logdna\_targets) | Map of logdna target to be created | <pre>map(object({<br>    instance_id   = string<br>    ingestion_key = string<br>    target_region = optional(string)<br>  }))</pre> | `{}` | no |
