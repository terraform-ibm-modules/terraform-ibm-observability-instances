...
| <a name="input_permitted_target_regions"></a> [permitted\_target\_regions](#input\_permitted\_target\_regions) | List of regions where target can be defined. | `list(string)` | `null` | no |
