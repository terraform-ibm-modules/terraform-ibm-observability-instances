locals {
  ...
  cos_validate_condition = var.log_analysis_enable_archive && ((var.cos_instance_id == null || var.cos_bucket_name == null || var.cos_bucket_endpoint == null))
...
resource "logdna_archive" "archive_config" {
  count       = var.log_analysis_enable_archive ? 1 : 0
  provider    = logdna.ld
  integration = "ibm"
  ibm_config {
